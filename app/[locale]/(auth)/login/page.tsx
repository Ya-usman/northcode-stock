      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <Link href={`/${locale}`} onClick={e => { if ((window as any).Capacitor?.isNativePlatform?.()) e.preventDefault() }}>
            <img src="/logo-login-t.png" alt="StockShop" className="h-44 w-auto object-contain brightness-0 invert" style={{ filter: 'brightness(0) invert(1) drop-shadow(0 8px 24px rgba(0,0,0,0.55))' }} />
          </Link>
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  <button type="button" onClick={signInWithGoogle}
                    className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-gray-200 dark:border-white/20 bg-white dark:bg-white/10 hover:bg-gray-50 dark:hover:bg-white/15 text-gray-700 dark:text-white font-medium text-sm transition-colors">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xs text-muted-foreground uppercase tracking-wider">{t('or_separator')}</span>
                  <div className="flex-1 h-px bg-border dark:bg-white/20" />
                </div>
