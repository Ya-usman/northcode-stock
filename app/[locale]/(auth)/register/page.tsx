      ...
      >
        ...
        <div className="rounded-2xl bg-white shadow-2xl p-6">
          ...
          <div className="flex items-center gap-2 mb-6">
            <div className={`flex-1 h-1.5 rounded-full ${step >= 1 ? 'bg-northcode-blue' : 'bg-gray-200'}`} />
            <div className={`flex-1 h-1.5 rounded-full ${step >= 2 ? 'bg-northcode-blue' : 'bg-gray-200'}`} />
          </div>
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input {...register('full_name')} placeholder="Malam Usman Garba" className="pl-9" />
                  </div>
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input {...register('city')} placeholder="Kano, Kaduna, Sokoto…" className="pl-9" />
                  </div>
                  {errors.city && <p className="text-xs text-destructive">{errors.city.message}</p>}
                </div>

                <div className="space-y-1.5">
                  <Label>Téléphone WhatsApp <span className="text-muted-foreground text-xs">(optionnel)</span></Label>
                  <div className="relative">
                    <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input {...register('phone')} placeholder="+2348012345678" className="pl-9" />
                  </div>
                </div>
