  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6 text-center">
      <div className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-950/40 mb-6">
        <WifiOff className="h-10 w-10 text-stockshop-blue dark:text-blue-400" />
      </div>
      <h1 className="text-2xl font-bold text-stockshop-blue dark:text-blue-400 mb-2">You're offline</h1>
