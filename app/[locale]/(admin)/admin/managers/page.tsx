      ...
      {adding && (
        <div className="bg-gray-900 rounded-xl border border-gray-700 p-5 space-y-4">
          <h2 className="font-semibold text-white flex items-center gap-2">
            <Shield className="h-4 w-4 text-northcode-blue" /> Assigner un responsable
          </h2>
          ...
          <div className="flex gap-2">
            <Button onClick={handleAssign} loading={submitting} disabled={!form.email || !form.shop_id} className="bg-northcode-blue">
              Assigner
            </Button>
        ...
        return (
          <div key={shop.id} className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-800 flex items-center gap-3">
              <Store className="h-4 w-4 text-northcode-blue flex-shrink-0" />
